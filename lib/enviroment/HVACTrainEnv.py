...
class HvacEnv(HemsEnv):
    ...
    #STATE (sampleTime,Load,PV,DeltaSOC,pricePerHour,indoor temperature ,outdoor temperature )
        sampleTime,load,pv,pricePerHour,deltaSoc,indoorTemperature,outdoorTemperature,userSetTemperature,occupancy = self.state
    ...
    def reset(self):
        ...
        if int( self.i / 30) == 0:
            ...
            self.Occupancy = [min(max(x+y,0),5) for x,y in zip(self.allOccupancy['1'],self.randomOccupancy) ]
            ...
            self.GridPrice = [min(max(x+y,0),6.2) for x,y in zip(self.notSummerGridPrice,self.randomDeltaPrice) ]
            self.Occupancy = [min(max(x+y,0),5) for x,y in zip(self.allOccupancy['2'],self.randomOccupancy) ]
            ...
            self.GridPrice = [min(max(x+y,0),6.2) for x,y in zip(self.notSummerGridPrice,self.randomDeltaPrice) ]
            self.Occupancy = [min(max(x+y,0),5) for x,y in zip(self.allOccupancy['3'],self.randomOccupancy) ]
            ...
            self.GridPrice = [min(max(x+y,0),6.2) for x,y in zip(self.notSummerGridPrice,self.randomDeltaPrice) ]
            self.Occupancy = [min(max(x+y,0),5) for x,y in zip(self.allOccupancy['4'],self.randomOccupancy) ]
            ...
            self.GridPrice = [min(max(x+y,0),6.2) for x,y in zip(self.notSummerGridPrice,self.randomDeltaPrice) ]
            self.Occupancy = [min(max(x+y,0),5) for x,y in zip(self.allOccupancy['5'],self.randomOccupancy) ]
            ...
            self.GridPrice = [min(max(x+y,0),6.2) for x,y in zip(self.notSummerGridPrice,self.randomDeltaPrice) ]
            self.Occupancy = [min(max(x+y,0),5) for x,y in zip(self.allOccupancy['6'],self.randomOccupancy) ]
            ...
            self.GridPrice = [min(max(x+y,0),6.2) for x,y in zip(self.summerGridPrice,self.randomDeltaPrice) ]
            self.Occupancy = [min(max(x+y,0),5) for x,y in zip(self.allOccupancy['8'],self.randomOccupancy) ]
            ...
            self.GridPrice = [min(max(x+y,0),6.2) for x,y in zip(self.summerGridPrice,self.randomDeltaPrice) ]
            self.Occupancy = [min(max(x+y,0),5) for x,y in zip(self.allOccupancy['9'],self.randomOccupancy) ]
            ...
            self.GridPrice = [min(max(x+y,0),6.2) for x,y in zip(self.summerGridPrice,self.randomDeltaPrice) ]
            self.Occupancy = [min(max(x+y,0),5) for x,y in zip(self.allOccupancy['10'],self.randomOccupancy) ]
