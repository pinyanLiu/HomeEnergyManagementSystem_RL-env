...
class OneLevelSimulation(multiSimulation):
    def __init__(self):
        ...
        self.totalReward = []        
        self.environment = Environment.create(environment = OneLevelTestEnv,max_episode_timesteps=960)
    ...
    def outputResult(self,mode):
        ...
        if mode == "hvac":
            ...
            output.plotPgridMax()
            output.plotPVPower()
            output.plotResult('lib/plot/OneLevel/hvac/')
            ...
            output.plotPVPower()
            output.plotDeltaSOCPower()
            output.plotResult('lib/plot/OneLevel/soc/')
            ...
            output.plotDeltaSOCPower()
            output.plotResult('lib/plot/OneLevel/int/')
            ...
            output.plotResult('lib/plot/OneLevel/unint/') 
        else:
            output.remainPower()
            output.soc()
            output.price()
